    ...
    <div :class="ppNs.e('body-wrapper')">
      ...
      <div :class="ppNs.e('body')">
        ...
        >
          ...
          <span>
            <el-icon :style="formatterStyle(customStyle, ['text'])"
              ><arrow-right
            /></el-icon>
          </span>
...
const handleRangePick = (
  ...
  const maxDate_ = formatEmit(
    max_ ? max_.add(1, 'day').subtract(1, 'millisecond') : null,
    1
  )
  ...
  emit('calendar-change', [
    min_.toDate(),
    max_ && max_ && max_.add(1, 'day').subtract(1, 'millisecond').toDate(),
  ])
