...
import { isArray, formatterStyle, type CustomStyle } from '@element-plus/utils'
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const inputValue = computed(() => API.states.inputValue)

    provide('displayInputValue', inputValue)

    const confirmChecked = (arr: Option[], event: Event) => {
      API.onSelectMutiple(arr)
