<template>
  <div :style="style" :class="containerKls">
    <!-- icon & line -->
    <div v-if="isCustom" :class="[ns.e('head'), ns.is(currentStatus)]">
      <div
      ...
      >
        <slot name="icon">
          ...
          <el-icon
            v-else-if="['success', 'finish'].includes(currentStatus)"
...
const isCircle = computed(() => {
  return parent.props.circle
})

const isCustom = computed(() => {
  return parent.props.custom
})
